...
public class TripUploader extends AsyncTask <Long, Integer, Boolean> {
    ...
    protected void onPreExecute() {
        Toast.makeText(mCtx.getApplicationContext(),"Submitting trip. Thanks for using WeBikeSD!", Toast.LENGTH_LONG).show();
    }
    ...
    protected void onPostExecute(Boolean result) {
        try {
            if (result) {
                ...
                Toast.makeText(mCtx.getApplicationContext(),"WeBikeSD couldn't upload the trip, and will retry when your next trip is completed.", Toast.LENGTH_LONG).show();
            }
        } catch (Exception e) {
